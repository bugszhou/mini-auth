(function (global, factory) {
  ...
  function weappLogin(){var _ref=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{timeout:2e4},timeout=_ref.timeout,self=_ref.self;return new promise$1(function(resolve,reject){wx.login({timeout:timeout,success:function success(res){resolve({errCode:0,errMsg:"",jsCode:res.code}),emitEvt(self,TOKEN_WX_SUCCESS_LOGIN,{res:res});},fail:function fail(err){reject({errCode:5e3,errMsg:err.errMsg||stringify$1(err),jsCode:""}),emitEvt(self,TOKEN_WX_FAIL_LOGIN,{err:err});}}),emitEvt(self,TOKEN_WX_BEFORE_LOGIN,{timeout:timeout});})}
  ...
  var gloableObj=getGlobal();function myLogin(){var _ref=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{scopes:["auth_base"]},scopes=_ref.scopes,self=_ref.self;return new promise$1(function(resolve,reject){gloableObj.getAuthCode({scopes:scopes,success:function success(res){resolve({errCode:0,errMsg:"",jsCode:res.authCode}),emitEvt(self,TOKEN_ALI_SUCCESS_LOGIN,{res:res});},fail:function fail(err){reject({errCode:5009,errMsg:err.errMsg||stringify$1(err),jsCode:""}),emitEvt(self,TOKEN_ALI_FAIL_LOGIN,{err:err});}}),emitEvt(self,TOKEN_ALI_BEFORE_LOGIN,{scopes:scopes});})}
